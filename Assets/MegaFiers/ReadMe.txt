...
Version 1.58
Fixed a bug when adding the MegaWrap to an object, would get errors in the console until a target was selected
MegaWrap objects now work when saved to a prefab and added back into the scene.

Version 1.57
MegaFiers 2 updated for Unity 6
